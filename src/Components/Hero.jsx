  ...
  return (
    <div>
      <div className='h-screen flex flex-col justify-center px-20 py-90 bg-blue-200'>
        ...
        <div className='absolute w-80 h-80 right-120 rounded-full border-2 animate-[bounce_8s_ease-out_infinite] max-sm:right-40'></div>
        <div className='absolute w-100 h-100 right-60 top-120 rounded-full border-2 animate-[bounce_12s_ease-in-out_infinite] max-sm:right-5'></div>
      </div>
    </div>
  )
}
