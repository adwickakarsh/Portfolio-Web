  ...
  return (
    <div className='p-12 flex items-center justify-around text-xl bg-hite max-sm:p-8'>
        ...
        <div className='flex gap-10 max-md:flex-col'>
          <button className='bg-black text-white p-4 transition-all duration-400 rounded-xl hover:scale-120 hover:bg-green-600 max-lg:scale-90'>
          <a href="/DataAnalystAdwick.pdf" download='ResumeAdwickAkarsh.pdf' target='_blank'>View Resume</a>
        </button>
        <button className='bg-black text-white p-4 transition-all duration-400 rounded-xl hover:scale-120 hover:bg-yellow-600 max-lg:scale-90'>
