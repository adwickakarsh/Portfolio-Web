...
const Navbar = () => {
  ...
  return (
    <div>
      <button
        onClick={toggleMenu}
        className="fixed top-7 right-30 z-30 flex flex-col gap-0.5 justify-center items-center w-15 h-15 rounded-full transition-all duration-800 ease-out hover:bg-blue-400 hover:scale-120"
      ...
      <div
        ...
        <div className="w-screen flex items-center justify-center h-screen text-black">
          <nav className="flex items-center gap-10 text-2xl">
            <a target='_blank' href="https://github.com/adwickakarsh" className="transition-all rounded-xl duration-500 ease-out bg-black p-7 text-blue-300 hover:text-blue-100 hover:scale-120 hover:bg-blue-600" onClick={toggleMenu}>
              <Github size={60} strokeWidth={1.3}/>
            </a>
            <a href="https://linkedin.com/in/adwickakarsh" target='_blank' className="transition-all rounded-xl duration-500 ease-out bg-black p-7 text-blue-300 hover:text-blue-100 hover:scale-120 hover:bg-blue-600" onClick={toggleMenu}>
              <Linkedin size={60} strokeWidth={1.3} />
            </a>
            <a href="mailto:adwick0704@gmail.com" target='_blank' className="transition-all rounded-xl duration-500 ease-out bg-black p-7 text-blue-300 hover:text-blue-100 hover:scale-120 hover:bg-blue-600" onClick={toggleMenu}><Mail size={60} strokeWidth={1.3} /></a>
          </nav>
        </div>
      </div>
